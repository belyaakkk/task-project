...
@Builder
@Schema(description = "Category information with task statistics")
public record CategoryWithTasksResponse(
        ...
        @Schema(description = "Number of active tasks in this category", example = "42")
        long taskCount
) {
}